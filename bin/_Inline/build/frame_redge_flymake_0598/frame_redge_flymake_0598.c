 ...
 * contents of frame_redge_flymake_0598.xs. Do not edit this file, edit frame_redge_flymake_0598.xs instead.
 *
 *	ANY CHANGES MADE HERE WILL BE LOST! 
 *
 */

#line 1 "frame_redge_flymake_0598.xs"
#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
#include "INLINE.h"
...
#line 82 "frame_redge_flymake_0598.c"
...
#line 82 "frame_redge_flymake_0598.xs"
	I32* temp;
#line 125 "frame_redge_flymake_0598.c"
#line 84 "frame_redge_flymake_0598.xs"
...
#line 136 "frame_redge_flymake_0598.c"
	PUTBACK;
	return;
    }
}
...
XS(XS_main_free_redge)
{
    ...
    {
	void *	redge = INT2PTR(void *,SvIV(ST(0)));
#line 98 "frame_redge_flymake_0598.xs"
	I32* temp;
#line 160 "frame_redge_flymake_0598.c"
#line 100 "frame_redge_flymake_0598.xs"
	temp = PL_markstack_ptr++;
	free_redge(redge);
	if (PL_markstack_ptr != temp) {
          /* truly void, because dXSARGS not invoked */
	  ...
	  XSRETURN_EMPTY; /* return empty stack */
        ...
        /* must have used dXSARGS; list context implied */
	return; /* assume stack size is correct */
#line 171 "frame_redge_flymake_0598.c"
	PUTBACK;
	return;
    }
}
...
extern "C"
#endif
XS(boot_frame_redge_flymake_0598); /* prototype to pass -Wmissing-prototypes */
XS(boot_frame_redge_flymake_0598)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
